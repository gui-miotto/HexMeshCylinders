...
Cylinder.edge = edge
cylinders = [
    Cylinder(diameter=get_odd_diam(350E-6), height= 50E-6, n_layers= 10),
    Cylinder(diameter=get_odd_diam(300E-6), height=200E-6, n_layers= 50),
    Cylinder(diameter=get_odd_diam( 50E-6), height=150E-6, n_layers=150),
...
s.export('fake_case/constant/polyMesh_fine/')
